...
public class MyVariable {
    public static void main(String[] args) {
        ...
        x = 1; // กำหนดให้ตัวแปร x มีค่าเท่ากับ 10
        System.out.println("x = "+x);
        int y = 2; //ประกาศตัวแปรชื่อ y และกำหนดค่าให้เท่ากับ 20
        y = 2; // กำหนดให้ตัวแปร y มีค่าเท่ากับ 20
        ...
        //charraoter ตัวอักษรเพียง 1 ตัวเท่านั้น เช่น # $ % A a
        char c = 'c';
